      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <a href="#" className="text-2xl font-serif tracking-wide">LENS</a>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Весілля</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} LENS Photography. Усі права захищено.</p>
          <p className="text-gray-400 mt-2 md:mt-0">Створено з пристрастю</p>
        </div>
      </div>
    </footer>
  );
