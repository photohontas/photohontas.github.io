        ...
        <div className="flex flex-col md:flex-row md:gap-12 items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 text-lg mb-6">
              Фотограф з більш ніж 5-річним досвідом, я спеціалізуюся на
            ...
            <p className="text-gray-700 text-lg mb-6">
              ...
              Мої роботи можна переглянути на моїй Insagram сторінці.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 mt-8">
              <div className="text-center">
                <h3 className="font-serif text-4xl font-bold">5+</h3>
              ...
              <div className="text-center">
                <h3 className="font-serif text-4xl font-bold">Безліч</h3>
                <p className="text-gray-500">Задоволених клієнтів</p>
              </div>
            </div>
          </div>
        </div>
